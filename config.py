...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--epsilon_noise', type=float, default=3.0)

    #Correlation Remove Degree
    parser.add_argument('--correlation_v', type=float, default=0.3)
    parser.add_argument('--correlation_a', type=float, default=0.3)
    parser.add_argument('--correlation_t', type=float, default=0.3)
